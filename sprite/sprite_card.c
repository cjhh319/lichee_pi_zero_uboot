...
int sunxi_sprite_deal_fullimg(void)
{
    ...
    printf("sunxi_sprite_deal_fullimg step1\n");
    ...
    printf("sunxi_sprite_deal_fullimg step2\n");
    ...
    printf("sunxi_sprite_deal_fullimg step3\n");

    ret1 = __download_fullimg_part(down_buff);
    printf("sunxi_sprite_deal_fullimg step4\n");
    if(ret1 != 0)
    {
        printf("sunxi sprite err: sunxi_sprite_deal_part, download normal failed\n");
	...
	printf("[debug_jaosn]:full = %d\n",full);
	if(full == 0)
	{
		printf("[debug_jaosn]:this is for IPC card product\n");
		sunxi_sprite_setdata_finish();
	}
	else
	{
		printf("[debug_jaosn]:this is for CDR card product\n");
